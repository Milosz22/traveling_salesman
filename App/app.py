...
class Background(FloatLayout):
    def __init__(self, **kwargs):
        ...
        layout = FloatLayout()
        with self.canvas:
            self.rect = Rectangle(source='pict.jpg', pos=layout.pos, size=self.size)
    ...
    def resize(self, *_):
        ...
        self.clear_widgets()
        with self.canvas:
            self.rect = Rectangle(source='annie-spratt-Uk3t05ndSng-unsplash.jpg', pos=self.pos, size=self.size)
